        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                <dt class="title">选择{{ skuSaleAttrValue.saleAttrName }}</dt>
                <dd changepirce="0" @click="changeActive(index)" ref="saleAttr">
...
export default {
  ...
  methods: {
    changeActive(index) {
      let domObj = this.$refs.saleAttr;
      $('.active').removeClass('active');
      $(domObj[index]).addClass('active');
    },
    getGoodsDetailInfo() {
      this.$store.dispatch('getGoodsDetailInfo', this.goodsId);
    },
  },
};
</script>
